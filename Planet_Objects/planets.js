...
//   ];
  ...
  // don't forget that you have to create a variable that says where the key goes, then create the key, THEN push the key
  // const earthPlus = solarSystem[2];
  // earthPlus.diameter="7,917.5 mi";

  // solarSystem.push([earthPlus.diameter])
...
// solarSystem[6].moons=["Miranda", "Titania", "Ariel", "Oberon"]
...
// parseInt(system.jupiter.satellites) + "<br>";
// check that above works
// console.log(system.jupiter.satellites)

// const satelliteCount = new Map();
// satelliteCount.set(parseInt(system.jupiter.satellites));
// satelliteCount.set(system.saturn.satellites);
// satelliteCount.set(system.uranus.satellites);
// satelliteCount.set(system.neptune.satellites)
// got me the numbers does not work in a function :(

// addition (satelliteCount)
// var addition = (x,y,z,w) => {
//     var sum = x+=y+=z+=w
// console.log(sum)}
// this did not work
...
// if (system.mercury.radiusp == ""){
//   let system.mercury.radiusp = system.mercury.radiuse
// }
// this also did not work

// 5. console.log Mercury's radiusp (should be 2439, not 'same').
// console.log(system.mercury.radiusp)
// so of course this just prints "same"
